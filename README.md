...
| TB2     | 10/06/2025  | Ramiro Alexander Guzmán Chávez        | Realizó mejoras con respecto a la TB2 y creó y colaboró en el sprint 3. |
| TB2     | 20/06/2025  | Fátima Andrea Asmad Padilla           | Realizó mejoras con respecto a la TB2 y creó  y colaboró en el sprint 3. |
...
|---------------------|---------------------|--------------|
| **1. Comunica oralmente con efectividad a diferentes rangos de audiencia** | **TB1:** <br> **Ramiro Alexander Guzmán Chávez**: Coordinó reuniones del equipo, guiando las discusiones y aclarando dudas para mantener el enfoque.<br>**Fatima Andrea Asmad Padilla**: Participó activamente en las reuniones grupales, compartiendo ideas y sugerencias de mejora.<br>**Jeremy Alexander Quijada Magro**: Explicó avances del equipo en reuniones de coordinación con otros grupos.<br>**Gabriel Huang Liu Franco**: Comunicó hallazgos técnicos durante las sesiones internas, facilitando la comprensión entre miembros no técnicos.<br>**Mauricio Rigoberto Muñoz Vilcapoma**: Brindó aportes claros y organizados durante las reuniones internas, ayudando a tomar decisiones en grupo. <br><br> **TP:** <br> **Ramiro Alexander Guzmán Chávez**: Lideró reuniones técnicas para revisar y corregir observaciones de la TB1, explicando claramente los ajustes requeridos y coordinando la integración de los componentes del frontend. <br> **Fatima Andrea Asmad Padilla**: Comunicó de forma clara las mejoras implementadas en su parte del frontend, respondiendo preguntas del equipo y proponiendo soluciones a detalles visuales y de usabilidad. <br> **Jeremy Alexander Quijada Magro**: Presentó los cambios aplicados a la documentación del trabajo previo y explicó su funcionalidad del frontend, adecuando su comunicación al nivel técnico de sus compañeros. <br> **Gabriel Huang Liu Franco**: Describió los procesos técnicos implicados en su sección del frontend, adaptando su lenguaje para asegurar que todos los miembros comprendieran el flujo de datos y estructura del código. <br> **Mauricio Rigoberto Muñoz Vilcapoma**: Explicó con claridad la lógica detrás de los componentes que desarrolló, resolviendo dudas del grupo y proponiendo ajustes durante el despliegue conjunto. <br><br> **TB2:** <br> **Ramiro Alexander Guzmán Chávez**: Lideró la defensa del avance técnico ante docentes, respondiendo preguntas con claridad. <br> **Fatima Andrea Asmad Padilla**: Presentó las decisiones de diseño y justificó sus elecciones con base en la experiencia de usuario. <br> **Jeremy Alexander Quijada Magro**: Expuso el flujo de funcionalidades del frontend con claridad para todos los participantes. <br> **Gabriel Huang Liu Franco**: Detalló aspectos técnicos de la arquitectura de frontend. <br> **Mauricio Rigoberto Muñoz Vilcapoma**: Explicó el proceso de integración de funcionalidades desde su lógica de programación. <br><br> **TF:** <br> **Ramiro Alexander Guzmán Chávez**: Dirigió la presentación del avance final del proyecto, respondiendo preguntas técnicas y organizativas de manera clara frente a evaluadores. <br> **Fátima Andrea Asmad Padilla**: Expuso de forma efectiva las decisiones de diseño tomadas en el frontend, contextualizando su relevancia para usuarios finales. <br> **Jeremy Alexander Quijada Magro**: Comunicó el impacto de las funcionalidades desarrolladas, adecuando su explicación tanto para miembros técnicos como no técnicos del jurado. <br> **Gabriel Huang Liu Franco**: Explicó los flujos de datos implementados y la arquitectura del sistema, adaptando su discurso según la audiencia. <br> **Mauricio Rigoberto Muñoz Vilcapoma**: Respondió preguntas relacionadas con la lógica de negocio, utilizando un lenguaje claro y profesional. | **TB1**: <br> En esta etapa de desarrollo, el equipo ha demostrado habilidades de comunicación oral efectivas para la coordinación interna y el trabajo colaborativo. Han logrado mantener una comunicación fluida, lo cual ha sido clave para la organización y avance del proyecto.<br><br> **TP**:  <br> El equipo continuó demostrando una comunicación oral efectiva, ahora con un enfoque más técnico y orientado a la solución de problemas. La capacidad para explicar sus contribuciones individuales en el desarrollo del frontend, así como la colaboración para corregir observaciones de la TB1, evidenció una mejora en la articulación de ideas hacia distintos niveles de audiencia, consolidando el trabajo en equipo y el avance del proyecto.<br><br> **TB2**:<br> El equipo reforzó la claridad y efectividad de su comunicación oral, evidenciando mayor dominio técnico y capacidad de síntesis al presentar avances. Se observó un lenguaje más preciso y enfocado en los objetivos del proyecto, lo que facilitó la toma de decisiones y la integración de componentes desarrollados.<br><br> **TF:** <br> El equipo consolidó sus habilidades de comunicación oral, logrando transmitir efectivamente los aspectos técnicos, funcionales y organizativos del proyecto frente a distintas audiencias. Se evidenció seguridad, dominio del tema y capacidad de adaptar el lenguaje según el perfil del interlocutor. Esto reflejó un alto nivel de preparación y cohesión grupal. |
| **2. Comunica por escrito con efectividad a diferentes rangos de audiencia** | **TB1:** <br> **Ramiro Alexander Guzmán Chávez**: Redactó partes del documento principal del proyecto, incluyendo la definición del problema.<br>**Fátima Andrea Asmad Padilla**: Encargada de la sección de requerimientos y criterios de aceptación.<br>**Jeremy Alexander Quijada Magro**: Redactó documentos de planificación como cronogramas y tareas.<br>**Gabriel Huang Liu Franco**: Documentó aspectos técnicos del desarrollo para ser comprendidos por todo el equipo.<br>**Mauricio Rigoberto Muñoz Vilcapoma**: Contribuyó con la redacción de objetivos y marco teórico del proyecto. <br><br> **TP:** <br> **Ramiro Alexander Guzmán Chávez**:  Revisó y mejoró la redacción de la introducción y justificación del proyecto, asegurando claridad y coherencia en la presentación de los ajustes realizados en la TP. <br>**Fátima Andrea Asmad Padilla**: Actualizó los requerimientos funcionales y no funcionales, redactando criterios de aceptación más precisos para reflejar los avances implementados en el frontend.<br> **Jeremy Alexander Quijada Magro**: Elaboró un nuevo cronograma ajustado al trabajo realizado en la TP y detalló las tareas corregidas y completadas, utilizando un lenguaje claro y accesible. <br>**Gabriel Huang Liu Franco**: Redactó la documentación técnica relacionada al despliegue del frontend, enfocándose en que fuera comprensible tanto para perfiles técnicos como no técnicos del equipo. <br>**Mauricio Rigoberto Muñoz Vilcapoma**: Revisó y fortaleció la redacción del marco teórico y los objetivos específicos, incorporando mejoras sugeridas en la retroalimentación de la TB1. <br><br> **TB2:** <br> **Ramiro Alexander Guzmán Chávez**: Redactó la sección de validación de requisitos. <br> **Fátima Andrea Asmad Padilla**: Documentó cambios en la interfaz de usuario con claridad. <br> **Jeremy Alexander Quijada Magro**: Elaboró la planificación final con lenguaje claro y preciso. <br> **Gabriel Huang Liu Franco**: Detalló el flujo de navegación del sistema en el documento. <br> **Mauricio Rigoberto Muñoz Vilcapoma**: Redactó ajustes técnicos al backend y frontend con precisión. <br><br> **TF:** <br> **Ramiro Alexander Guzmán Chávez**: Redactó la conclusión general del informe final, integrando los aportes individuales en un discurso coherente. <br> **Fátima Andrea Asmad Padilla**: Elaboró la sección de mejoras futuras, utilizando un lenguaje técnico comprensible para distintas audiencias. <br> **Jeremy Alexander Quijada Magro**: Organizó y redactó el resumen ejecutivo del documento, facilitando una visión clara del proyecto. <br> **Gabriel Huang Liu Franco**: Documentó los aspectos técnicos finales del despliegue y configuraciones del sistema. <br> **Mauricio Rigoberto Muñoz Vilcapoma**: Redactó la introducción del informe final, asegurando claridad y adecuada contextualización del problema abordado. | **TB1:** <br> A través de documentos técnicos, organizativos y explicativos, el equipo ha mostrado capacidad de comunicación escrita clara y estructurada. La redacción ha permitido que todos los miembros comprendan sus responsabilidades y que el avance del proyecto esté bien documentado. <br><br> **TP**: <br> El equipo reforzó sus habilidades de comunicación escrita al actualizar y mejorar las secciones del documento original, incorporando correcciones y nuevos avances. La capacidad para expresar de forma clara y estructurada los aspectos técnicos, organizativos y conceptuales del proyecto permitió una mejor comprensión interna del trabajo realizado, así como una presentación más profesional y efectiva ante diferentes audiencias.<br><br> **TB2**:<br> El equipo demostró consistencia en la comunicación escrita, elaborando documentación técnica y organizativa que reflejó adecuadamente los avances del proyecto. La redacción fue precisa, facilitando la revisión, comprensión y seguimiento de las tareas tanto por el equipo como por evaluadores externos. <br><br> **TF:** <br> La comunicación escrita del equipo se fortaleció significativamente en esta fase, evidenciando capacidad para estructurar ideas con claridad, precisión y adecuación al público lector. El informe final reflejó un trabajo colaborativo bien documentado, lo que facilitó la evaluación integral del proyecto por parte de los revisores. |
...
| 4 | US-31 | Registrar doctor | Como administrador, quiero registrar la información de un doctor para mantener actualizada la base de datos médica del asilo. | 3 |
| 5 | US-32 | Editar doctor existente | Como administrador, quiero poder actualizar los datos de un doctor para corregir información o reflejar cambios en el personal. | 2 |
| 6 | US-33 | Crear perfil de enfermero | Como administrador, quiero registrar el perfil de un enfermero para tener un control del personal asistencial disponible. | 3 |
| 7 | US-34 | Registrar medicina | Como personal médico, quiero registrar nuevas medicinas en el sistema para controlar su uso en el tratamiento de los residentes. | 3 |
| 8 | US-35 | Eliminar medicina caducada | Como personal médico, quiero eliminar medicinas caducadas del sistema para evitar su uso por error. | 2 |
| 9 | US-38 | Registrar residente desde el frontend | Como cuidador o administrador, quiero registrar un nuevo residente desde una interfaz visual para facilitar su ingreso al sistema. | 3 |
| 10 | US-01 | Ver estado de salud del residente | Como familiar, quiero ver el estado de salud actualizado del residente para estar informado. | 5 |
| 11 | US-03 | Recibir alertas críticas | Como familiar, quiero recibir una alerta cuando la salud del residente esté en riesgo. | 5 |
| 12 | US-11 | Ver actividades diarias | Como familiar, quiero ver las actividades realizadas por mi ser querido para saber si participa y está activo. | 3 |
| 13 | US-12 | Registrar actividad del residente | Como cuidador, quiero registrar las actividades del residente para tener un seguimiento de su rutina diaria. | 3 |
| 14 | US-13 | Evaluar estado emocional del residente | Como cuidador, quiero registrar una evaluación emocional diaria para dar seguimiento a su bienestar psicológico. | 3 |
| 15 | US-14 | Consultar historial emocional del residente | Como familiar, quiero consultar el historial emocional del residente para comprender mejor su estado mental a lo largo del tiempo. | 3 |
| 16 | US-25 | Ver reporte semanal de estado del residente | Como familiar, quiero ver un reporte semanal de salud para entender la evolución general. | 5 |
| 17 | US-30 | Recibir recordatorios para revisar informes | Como familiar, quiero recibir recordatorios semanales para revisar los reportes y estar al tanto del estado del residente. | 2 |
| 18 | US-26 | Descargar reporte en PDF | Como familiar, quiero descargar el reporte semanal en formato PDF para archivarlo o compartirlo. | 2 |
| 19 | US-15 | Filtrar residentes por estado de salud | Como cuidador, quiero filtrar a los residentes según su estado de salud para priorizar la atención. | 3 |
| 20 | US-27 | Ver tendencias de salud por categoría | Como cuidador, quiero ver tendencias por categorías (nutrición, movilidad, ánimo) para ajustar planes de cuidado. | 5 |
| 21 | US-28 | Ver lista de residentes asignados | Como cuidador, quiero ver solo a los residentes que tengo asignados para optimizar mi trabajo. | 2 |
| 22 | US-36 | Generar reporte clínico por paciente | Como cuidador o médico, quiero registrar reportes clínicos por paciente para documentar diagnósticos y tratamientos aplicados. | 3 |
| 23 | US-37 | Consultar historial clínico del paciente | Como personal autorizado, quiero consultar el historial clínico de un paciente para entender su evolución médica. | 3 |
| 24 | US-39 | Gestionar reportes clínicos | Como doctor o encargado, quiero registrar, editar y eliminar reportes clínicos desde un formulario, para mantener actualizada la información médica del paciente. | 5 |
| 25 | US-09 | Consultar API de residentes (GET) | Como developer, quiero consultar el listado de residentes mediante la API para integrarlo al frontend. | 2 |
| 26 | US-10 | Validar credenciales del API | Como developer, quiero autenticarme con token para acceder a los servicios protegidos del API. | 1 |
| 27 | US-20 | Registrar un nuevo residente (API) | Como developer, quiero registrar un nuevo residente en la base de datos a través del API. | 2 |
| 28 | US-21 | Actualizar datos del residente (API) | Como developer, quiero actualizar los datos personales o médicos de un residente vía API. | 2 |
| 29 | US-22 | Obtener historial de actividades (API) | Como developer, quiero obtener el historial de actividades de un residente para mostrarlo en su perfil. | 3 |
| 30 | US-23 | Eliminar registro médico (API) | Como developer, quiero eliminar un registro médico incorrecto desde el API. | 2 |
| 31 | US-24 | Consultar métricas de salud (API) | Como developer, quiero obtener métricas resumidas del estado de un residente para visualizaciones en el dashboard. | 3 |
| 32 | US-04 | Enviar mensajes al personal | Como familiar, quiero enviar mensajes al personal para consultar sobre el residente. | 3 |
| 33 | US-05 | Ver respuestas del personal | Como familiar, quiero leer las respuestas a mis consultas para mantenerme informado. | 3 |
| 34 | US-29 | Evaluar la calidad del servicio | Como familiar, quiero dejar una evaluación de la atención brindada para contribuir con la mejora del servicio. | 2 |
| 35 | US-16 | Ver equipo profesional del asilo | Como visitante, quiero conocer el equipo profesional del asilo para confiar en su experiencia y formación. | 2 |
...
<p align="center">
  <img src="./assets/structurizr-101317-redVitalContainer.png" />
</p>
...
![Sprint3](./assets/sprint_backlog3.jpg)
...
**Frontend:**
![Evidence](./assets/front_pulse3.jpg)
![Evidence](./assets/front_netgraph3.jpg)
...
**Frontend:**
![Evidence](./assets/front_pulse4.jpg)
![Evidence](./assets/front_netgraph4.jpg)

**Backend:**
![Evidence](./assets/back_pulse4.jpg)
![Evidence](./assets/back_netgraph4.jpg)
